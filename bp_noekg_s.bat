@echo off
rem $Id: bp_noekg_s.bat,v 1.2 2001-04-26 16:11:02 peter Exp $
...
echo =========================
echo Making Bpnekgs.asm
echo =========================
asmtms\dspa.exe bpnekgs.asm -l -v2xx -s -w -dVersionFerrum=2 -dNewFerrum=1 -dMem=20
...
:compile
if exist bpnekgs.obj goto compile1
echo =========================
echo bpnekgs.obj not found
echo =========================
goto end
:compile1
...
echo Compile
echo =========================
asmtms\dsplnk bpnekgs.obj bp206.cmd -o bpnekgs.out -m bpnekgs.map
del bpnekgs.obj
